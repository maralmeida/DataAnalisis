...
select * from dbo.RegionVentas; --selecciono vista creada, a partir de aqui puedo ingestar la vista con los campos a usar en PowerBI
select * from ClientePais;
select * from ProductoMasVentas;